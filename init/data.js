const sampleListings = [
  {
    ...
    geoCoordinates:{
      type:"Point",
      coordinates:[-118.4957, 34.0259], // Longitude, Latitude for Malibu, CA
    }
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-73.9857, 40.7484]  // Longitude, Latitude for New York City
    }
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-106.8230, 39.1911]  // Longitude, Latitude for Aspen, CO
    }
  },
  {
  ...
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-122.6765, 45.5231]  // Longitude, Latitude for Portland, OR
    }
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-86.8515, 21.1743]  // Longitude, Latitude for Cancun, Mexico
    }
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-120.0386, 39.0968]  // Longitude, Latitude for Lake Tahoe
    }
  },
  {
  ...
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [7.2303, 46.0925]  // Longitude, Latitude for Verbier, Switzerland
    }
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [34.8007, -2.3333]  // Longitude, Latitude for Serengeti National Park
    }
  },
  {
  ...
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-1.8414, 51.9320]  // Longitude, Latitude for Cotswolds, United Kingdom
    }
  },
  {
  ...
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-115.2107, 51.1784]  // Longitude, Latitude for Banff, Canada
    }
  },
  {
  ...
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [98.2969, 7.8804]  // Longitude, Latitude for Phuket, Thailand
    }
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-4.2422, 56.4907]  // Longitude, Latitude for Scottish Highlands
    }
  },
  {
  ...
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [25.3275, 37.4467]  // Longitude, Latitude for Mykonos, Greece
    }
  },
  {
  ...
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-79.9309, 32.7765]  // Longitude, Latitude for Charleston, United States
    }
  },
  {
  ...
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-71.5799, 43.1939]  // Longitude, Latitude for New Hampshire
    }
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [73.4727, 3.2028]  // Longitude, Latitude for the Maldives
    }
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-106.8200, 39.1911]  // Longitude, Latitude for Aspen, Colorado
    }
  },
  {
    ...
    geoCoordinates: {
      type: "Point",
      coordinates: [-84.0734, 9.7489]  // Longitude, Latitude for Costa Rica
    }
  },
];
